...
const Projects = () => {
  const projects = [
    ...
    {
      title: "CV for Football Analysis (YOLOv8)",
      timeline: "2024",
      stack: ["Computer Vision", "YOLOv8", "Python"],
      highlights: [
        "Developed a computer vision system for football analytics using YOLOv8.",
        "Automated detection and tracking of players and ball for advanced match analysis.",
