...
const Accomplishments = () => {
  ...
  return (
    <section id="accomplishments" className="section bg-white">
      <div className="container">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {accomplishments.map((item, idx) => (
            ...
            >
              <div className={`mx-auto mb-4 w-16 h-16 rounded-full flex items-center justify-center text-${item.color} bg-${item.color}/10`}>
                {item.icon}
              </div>
